...
import { DegradedBannerGlobalMount } from "@/components/voice/DegradedBannerGlobalMount";
      ...
      <DegradedBannerMountedProvider>
        ...
        <SidebarProvider>
          ...
          <SidebarInset>
            ...
            {/* Mission C4 §T1.10 — global composite degraded banner.
                Yields to per-page mount via DegradedBannerMountedContext. */}
