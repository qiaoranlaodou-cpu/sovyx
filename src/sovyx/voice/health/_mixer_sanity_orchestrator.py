...
async def _check_and_maybe_heal_impl(
    ...
    *,
    ...
    # Phase 5.F.15 — runtime defaults live in independent modules;
    # lazy-imported here to break the cycle (orchestrator module would
    # otherwise need _mixer_sanity_persist + _linux_mixer_apply +
    # _linux_mixer_probe + _NoopTelemetry from parent at top-level).
    from sovyx.voice.health._linux_mixer_apply import (  # noqa: PLC0415
    ...
    from sovyx.voice.health._linux_mixer_probe import (  # noqa: PLC0415
        enumerate_alsa_mixer_snapshots as _default_mixer_probe,
    )
    from sovyx.voice.health._mixer_sanity import _NoopTelemetry  # noqa: PLC0415
    from sovyx.voice.health._mixer_sanity_persist import (  # noqa: PLC0415
